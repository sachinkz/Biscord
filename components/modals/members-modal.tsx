...
export const MembersModal = () => {
    ...
    const roleIconMap = {
        "GUEST": null,
        "MODERATOR": <ShieldCheck className="h-4 w-4 ml-2 mb-[2px] text-indigo-500 " />,
        "ADMIN": <ShieldAlert className="h-4 w-4 ml-2 mb-[2px] text-rose-500 " />
    }
    ...
    return (
        <Dialog open={isModalOpen} onOpenChange={onClose}>
            <DialogContent className="bg-white text-black rounded-lg overflow-hidden">
                        ...
                        <div key={member.id} className="flex items-center gap-x-2 mb-6">
                            ...
                            {server.profileId !== member.profileId && loadingId !== member.id && (
                                <div className="ml-auto">
                                    <DropdownMenu>
                                        <DropdownMenuTrigger>
                                            <MoreVertical h-4 w-4 text-zinc-400/>
                                        </DropdownMenuTrigger>
                                        <DropdownMenuContent>
                                            <DropdownMenuSub>
