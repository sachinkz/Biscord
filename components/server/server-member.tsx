...
export const ServerMember=({member,server}:ServerMembersProps)=>{
    ...
    return (
        <button onClick={onClick} className={cn("group px-2 py-2 rounde-md flex items-center gap-x-2 w-full hover:bg-zinc-700/50 transition mb-1"
