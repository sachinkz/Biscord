...
export const ServerChannel = ({channel,server,role}:ServerChannelProps) => {
    ...
    return (
        ...
        params?.channelId===channel.id && "bg-zinc-700/20 dark:bg-zinc-700")}>
            ...
            <p className={cn("line-clamp-1 font-semibold text-left text-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
